...
namespace CourseWork {
    ...
    public partial class enterpriseDataSet : global::System.Data.DataSet {
        ...
        public partial class logintableDataTable : global::System.Data.TypedTableBase<logintableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public logintableRow AddlogintableRow(string user_login, string user_password) {
        ...
        public partial class logintableRow : global::System.Data.DataRow {
            ...
            public string user_login {
                get {
                    return ((string)(this[this.tablelogintable.user_loginColumn]));
                }
                set {
                    this[this.tablelogintable.user_loginColumn] = value;
                }
            }
            ...
            public string user_password {
                get {
                    return ((string)(this[this.tablelogintable.user_passwordColumn]));
                }
                set {
                    this[this.tablelogintable.user_passwordColumn] = value;
                }
            }
        }
...
namespace CourseWork.enterpriseDataSetTableAdapters {
    ...
    public partial class logintableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `logintable` WHERE ((`id` = @p1) AND (`user_login` = @p2) AND (`user_" +
                "password` = @p3))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `logintable` SET `user_login` = @p1, `user_password` = @p2 WHERE ((`id` = " +
                "@p3) AND (`user_login` = @p4) AND (`user_password` = @p5))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `user_login`, `user_password` FROM `logintable`";
        ...
        public virtual int Fill(enterpriseDataSet.logintableDataTable dataTable) {
        ...
        public virtual enterpriseDataSet.logintableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            enterpriseDataSet.logintableDataTable dataTable = new enterpriseDataSet.logintableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(enterpriseDataSet.logintableDataTable dataTable) {
        ...
        public virtual int UpdateAll(enterpriseDataSet dataSet) {
            ...
            try {
                ...
                if ((this._logintableTableAdapter != null)) {
                    ...
                    this._logintableTableAdapter.Connection = ((global::MySql.Data.MySqlClient.MySqlConnection)(workConnection));
                    this._logintableTableAdapter.Transaction = ((global::MySql.Data.MySqlClient.MySqlTransaction)(workTransaction));
                ...
                if ((this._logintableTableAdapter != null)) {
                    this._logintableTableAdapter.Connection = ((global::MySql.Data.MySqlClient.MySqlConnection)(revertConnections[this._logintableTableAdapter]));
